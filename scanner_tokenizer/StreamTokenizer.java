...
public class StreamTokenizer implements Tokenizer {
    ...
    static {
    	...
    	final String symbolRegEx = "\\|\\||&&|==|\\+|\\*|/|=|\\(|\\)|;|,|\\{|\\}|<|-|!|@|\\[|\\]"; //group 4
	...
	private void checkType() {
		...
		if (scanner.group(NUM8.ordinal()) != null) { // NUM8
			tokenType = NUM8;
		//	intValue = Integer.decode(tokenString); //decode da rivedere
			intValue = Integer.parseInt(tokenString, 8); //ottimizzato?
			return;
		}
